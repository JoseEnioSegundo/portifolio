    ...
    <main>
      ...
      <section class="works">
        ...
        <ul>
          <li>
            <p>
              <img src="/image3.png" alt="Imagem de um dashboard" />
            </p>
          ...
          <li>
            <p>
              <img src="/image4.png" alt="Vibrant Portraits" />
            </p>
...
section.dashb ul li p {
  margin: 15px 0;
  color: black;
}

section.dashb ul li p.info {
  color: #21243d;
}

section.dashb ul li p.info span {
  background: #ff7c7c;
  color: white;
  border-radius: 16px;
  padding: 5px 10px;
